                ...
                <form action="{{ route('kategori.store') }}" method="POST">
                    ...
                    <div class="fields-panel">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" value="{{ old('nama') }}" placeholder="cth. Frozen Food"
                                required>
                        </div>

                        <div class="form-group">
                            <label>Deskripsi <span style="color:var(--gray-400);font-weight:400;">(opsional)</span></label>
                            <textarea name="deskripsi" placeholder="Masukkan deskripsi kategori...">{{ old('deskripsi') }}</textarea>
                        </div>
